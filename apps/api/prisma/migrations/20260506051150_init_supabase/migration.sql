-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'TEACHER', 'PARENT', 'ADMIN', 'PRINCIPAL', 'VICE_PRINCIPAL', 'COUNSELOR', 'SUPERVISOR', 'ACCOUNTANT', 'HR');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('INFO', 'SUCCESS', 'WARNING', 'ACHIEVEMENT', 'REMINDER', 'GRADE');
...
CREATE TABLE "User" (
    ...
    "name" TEXT,
    "phone" TEXT,
    "behaviorScore" DOUBLE PRECISION DEFAULT 75,
...
CREATE TABLE "MillionProfile" (
    ...
    CONSTRAINT "MillionProfile_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "MillionScore" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "MillionScore_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "MillionProfile_userId_key" ON "MillionProfile"("userId");

-- CreateIndex
CREATE INDEX "MillionScore_profileId_idx" ON "MillionScore"("profileId");

-- CreateIndex
CREATE INDEX "MillionScore_date_idx" ON "MillionScore"("date");
...
-- AddForeignKey
ALTER TABLE "MillionProfile" ADD CONSTRAINT "MillionProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MillionScore" ADD CONSTRAINT "MillionScore_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES "MillionProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
